...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'App\\Controller\\ApiMemberController' => 'getApiMemberControllerService',
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListener('kernel.exception', [0 => #[\Closure(name: 'App\\EventSubscriber\\EventSubscriber')] function () {
            return ($this->privates['App\\EventSubscriber\\EventSubscriber'] ?? $this->load('getEventSubscriberService'));
        }, 1 => 'onKernelException'], 0);
    ...
    {
        return $this->services['http_cache'] = new \Symfony\Bundle\FrameworkBundle\HttpCache\HttpCache(($this->services['kernel'] ?? $this->get('kernel', 1)), new \Symfony\Component\HttpKernel\HttpCache\Store(($this->targetDir.''.'/http_cache')), ($this->privates['esi'] ??= new \Symfony\Component\HttpKernel\HttpCache\Esi()), ['debug' => true]);
    }
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('9zd0BgfPdU', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? $this->getLoggerService()));
    }
